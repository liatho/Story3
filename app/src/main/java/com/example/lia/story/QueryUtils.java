...
public class QueryUtils {
    ...
    public static List<Story> fetchStoryData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of {@link Storie}s
    ...
    private static List<Story> extractFeatureFromJson(String storyJSON) {
        ...
        try {
            ...
            JSONArray storyArray = baseJsonResponse.getJSONObject("response").getJSONArray("results");
            ...
            for (int i = 0; i < storyArray.length(); i++) {
                ...
                // Create a new {@link Story} object with the sectionName, webTitle, webPublicationDate,
                // and url from the JSON response.
                Story story = new Story(sectionName, webTitle, webPublicationDate, url);
                // Add the new {@link Story} to the list of storiess.
                newList.add(story);
            }
